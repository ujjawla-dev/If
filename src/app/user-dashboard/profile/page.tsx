          ...
          <div className="flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
                ...
                <div className="bg-[#E6663E]/20 text-[#E6663E] text-[10px] font-bold px-2 py-0.5 rounded-full flex items-center gap-1 border border-[#E6663E]/30 uppercase tracking-widest">
            ...
            <div className="grid grid-cols-2 gap-4 md:border-l border-white/10 md:pl-8">
